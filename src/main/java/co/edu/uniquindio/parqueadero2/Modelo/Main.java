...
public class Main {
    ...
    public static Map<String, Double> registroDiario = new HashMap<>();
    public static Map<String, Double> registroMensual = new HashMap<>();
    ...
    private static void registrarVehiculo(Scanner scanner) {
        ...
        if (parqueadero != null) {
            ...
            System.out.println("Ingrese la hora de ingreso (formato militar HH:mm):");
    ...
    private static long calcularTiempoEstacionado(String horaSalida, String horaIngreso) {
    ...
    private static Parqueadero obtenerParqueadero(int codigoParqueadero) {
    ...
    public static String generarReporteDiario() {
        StringBuilder reporteDiario = new StringBuilder("Reporte Diario:\n");
        for (Map.Entry<String, Double> entry : registroDiario.entrySet()) {
            reporteDiario.append("Fecha: ").append(entry.getKey()).append(", Total Recaudado: $").append(decimal.format(entry.getValue())).append("\n");
        }
        return reporteDiario.toString();
    }

    public static String generarReporteMensual() {
        StringBuilder reporteMensual = new StringBuilder("Reporte Mensual:\n");
        for (Map.Entry<String, Double> entry : registroMensual.entrySet()) {
            reporteMensual.append("Mes: ").append(entry.getKey()).append(", Total Recaudado: $").append(decimal.format(entry.getValue())).append("\n");
        }
        return reporteMensual.toString();
    }
